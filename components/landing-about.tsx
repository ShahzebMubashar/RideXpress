    ...
    <div className="h-[26rem] pt-20 px-16 bg-[#218A94]">
      <div className="flex col-span-2 gap-24 justify-center">
        <div className="w-96">
          ...
          <div className="mb-8 ">
          Ready to start your journey towards sustainable commuting? Join RideXpress and be part of the solution. Together, we can make a real impact on our environment while enjoying the benefits of cost-effective, hassle-free transportation.
          </div>
        </div>
